      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <a>
          <div class="rounded-md shadow mt-5">
            <nuxt-link
              class="w-full flex items-center justify-center py-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10"
              to="/testvive"
              >Coivd Table</nuxt-link
            >
          </div>
        </a>
      </div>
